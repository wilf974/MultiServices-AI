...
C2 (provenance) : source explicite. Par defaut `project:wilfred` (decisions humaines) ou
...
def log(journal_path, kind: str, text: str, source: str = "project:wilfred",
...
def main() -> None:
    ...
    p.add_argument("--source", default="project:wilfred",
                   help="provenance C2 ; prefixe 'project:' pour isoler du chat (project:wilfred, project:claude)")
