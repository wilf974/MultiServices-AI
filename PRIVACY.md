...
Cette politique couvre l'API REST `https://api-mem.example.com` (la « Mémoire »), utilisée par
des assistants IA (Custom GPT, connecteurs, scripts) pour lire et écrire une mémoire personnelle.

## Responsable
Service personnel auto-hébergé. Contact : **contact@example.com**.
...
## Vos droits
Accès, rectification, suppression : écrire à **contact@example.com**.
