...
> **Prerequis infra** : le vhost `api-mem.woutils.com.nginx` ecoute `8443 ssl proxy_protocol`
> (comme `mem.woutils.com`/`aether.conf`). Il SUPPOSE un front (HAProxy/nginx amont) qui termine
